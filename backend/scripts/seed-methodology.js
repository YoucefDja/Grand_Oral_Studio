...
const STEP_SCHEMAS = [
  ...
  },
  {
    ...
    jsonSchemaDescription: [
      ...
      '- "type" parmi : "introduction" | "contenu" | "donnees" | "exemple_entreprise" | "conclusion".',
      ...
      'Exigences : une slide d\'introduction qui reprend explicitement la ligne directrice ; au moins une slide "donnees" (chiffres) dans la partie contexte ; au moins une slide "exemple_entreprise" réelle ; une slide "conclusion" qui synthétise la réponse et rappelle la ligne directrice.',
