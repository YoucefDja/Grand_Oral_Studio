...
const STEP_SCHEMAS = [
  ...
  },
  {
    ...
    jsonSchemaDescription: [
      ...
      '- "notes_orateur" : texte destiné au panneau « Notes » du présentateur. Rôle : permettre à l\'étudiant de s\'approprier la slide en un coup d\'œil, PAS de rédiger un cours.',
      'RÈGLES DES NOTES ORATEUR (à respecter pour CHAQUE slide de contenu) :',
      '  1. COURTES ET NON THÉORIQUES : 3 à 5 phrases maximum (soit 40 à 90 mots). Une note n\'est pas une dissertation : pas de développement académique, pas de rappel de théorie, pas de digression absente de la slide.',
      '  2. ADOSSÉES À LA SLIDE : les notes ne présentent QUE ce qui figure sur la slide (les puces, le chiffre, l\'exemple d\'entreprise, le visuel). Chaque puce de la slide doit être reprise et explicitée par une phrase, dans le même ordre. Rien de plus : si une idée n\'est pas sur la slide, elle n\'est pas dans les notes.',
      '  3. STYLE ORAL ET PERSONNEL : phrases courtes, construites comme à l\'oral, à la première personne quand c\'est naturel (« je préconise… », « ce chiffre montre que… »). Objectif : l\'étudiant doit pouvoir lire la note une fois puis parler sans la relire — jamais un style écrit ou « généré par une IA ».',
      '  4. CONTENU UTILE : rappeler l\'idée clé de la slide, préciser le chiffre ou l\'exemple cité (avec sa source si elle figure sur la slide), et dire en une phrase le lien avec la problématique ou la transition vers la slide suivante. Une note = de quoi dire la slide, rien de plus.',
      '  5. INTERDITS : pas de paragraphe fleuve, pas de définition théorique, pas d\'énumération de données absentes de la slide, pas de répétition mot pour mot des puces (on explicite, on ne recopie pas).',
      '  Pour la page de titre : aucune note. Pour la slide « problématique » : la note énonce la question et la tension qui la fait naître, en 2-3 phrases.',
      ...
      'Cible de volume : entre 22 et 25 slides au total dans le fichier final, page de titre comprise (elle est ajoutée automatiquement à l\'export) — fourchette stricte à respecter précisément : génère donc 21 à 24 slides de contenu, la slide de conclusion incluse. Répartition indicative : contexte & accroche 2, enjeux 1-2, slide problématique 1, existant / état de l\'art 6-8, statistiques chiffrées 2-3, cas réels d\'entreprise 3-4, solutions & préconisations 5-7, conclusion 1. Si le contenu naturel tombe sous 22 slides, développe les slides "existant" et "solutions" (chiffres supplémentaires, cas d\'entreprise, schémas) plutôt que de dupliquer des slides ; ne dépasse jamais 25 slides.',
