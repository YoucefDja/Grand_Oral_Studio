...
const STEP_SCHEMAS = [
  ...
  },
  {
    ...
    jsonSchemaDescription: [
      ...
      '- "titre" : titre de la slide, JAMAIS une phrase. Deux ou trois mots maximum, en mots-clés, lisibles d\'un coup d\'œil par le jury ("Contexte", "Mots-clés", "Enjeux", "Problématique", "Existant", "Chiffres clés", "Cas d\'entreprise", "Solutions", "Conclusion"). Aucun verbe conjugué, aucun point, aucun sous-titre explicatif : le développement va dans les puces et les notes, jamais dans le titre.',
      ...
      'SIMPLIFICATION TECHNIQUE ET VULGARISATION : le niveau de technicité des slides doit rester accessible à un jury professionnel de non-spécialistes. Évite l\'accumulation de normes, de référentiels techniques et d\'acronymes complexes si cela n\'est pas strictement indispensable à la démonstration. Priorise la clarté et la concision pour éviter de susciter des questions pièges sur le jargon en fin de présentation. Le glossaire est le seul endroit pour les définitions techniques indispensables, qui doivent y être rédigées en langage clair.',
