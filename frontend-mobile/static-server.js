 ...
 * Gère le fallback SPA : toute route inconnue renvoie index.html.
 *
 * Utilisé par le service Railway "grand-oral-studio-news-mobile" (npm start).
 */
...
createServer(async (req, res) => {
  ...
  console.log(`Grand Oral Studio — News mobile servi sur le port ${PORT} (dist/).`);
});
